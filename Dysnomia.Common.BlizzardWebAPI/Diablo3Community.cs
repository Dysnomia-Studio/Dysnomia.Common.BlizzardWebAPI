...
namespace Dysnomia.Common.BlizzardWebAPI {
    ...
    /// </summary>
    public class Diablo3Community : BlizzardWebAPIQuerier, IDiablo3Community {
        ...
        public async Task<Diablo3ActIndex> GetActIndex(string accessToken, string region, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3ActIndex>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/act?locale={1}",
                    region, locale
                ),
                accessToken
            );
        ...
        public async Task<Diablo3Act> GetAct(string accessToken, string region, int actId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Act>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/act/{1}?locale={2}",
                    region, actId, locale
                ),
                accessToken
            );
        ...
        public async Task<Diablo3Artisan> GetArtisan(string accessToken, string region, string artisanSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Artisan>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/artisan/{1}?locale={2}",
                    region, artisanSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3ArtisanTrainingTierRecipe> GetRecipe(string accessToken, string region, string artisanSlug, string recipeSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3ArtisanTrainingTierRecipe>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/artisan/{1}/recipe/{2}?locale={3}",
                    region, artisanSlug, recipeSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3Follower> GetFollower(string accessToken, string region, string followerSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Follower>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/follower/{1}?locale={2}",
                    region, followerSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3CharacterClass> GetCharacterClass(string accessToken, string region, string classSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3CharacterClass>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/hero/{1}?locale={2}",
                    region, classSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3Skill> GetApiSkill(string accessToken, string region, string classSlug, string skillSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Skill>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/hero/{1}/skill/{2}?locale={3}",
                    region, classSlug, skillSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<IEnumerable<Diablo3ItemTypeIndex>> GetItemTypeIndex(string accessToken, string region, string locale = "en_US") {
            return await this.GetUsingTokenAsync<IEnumerable<Diablo3ItemTypeIndex>>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/item-type?locale={1}",
        ...
        public async Task<IEnumerable<Diablo3ItemType>> GetItemType(string accessToken, string region, string itemTypeSlug, string locale = "en_US") {
            return await this.GetUsingTokenAsync<IEnumerable<Diablo3ItemType>>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/item-type/{1}?locale={2}",
                    region, itemTypeSlug, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3Item> GetItem(string accessToken, string region, string itemSlugAndId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Item>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/data/item/{1}?locale={2}",
                    region, itemSlugAndId, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3Account> GetAccount(string accessToken, string region, string account, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Account>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/profile/{1}/?locale={2}",
                    region, account.Replace("#", "%23"), locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3Hero> GetHero(string accessToken, string region, string account, ulong heroId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3Hero>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/profile/{1}/hero/{2}?locale={3}",
                    region, account.Replace("#", "%23"), heroId, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Diablo3HeroDetailedItems> GetDetailedHeroItems(string accessToken, string region, string account, ulong heroId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3HeroDetailedItems>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/profile/{1}/hero/{2}/items?locale={3}",
                    region, account.Replace("#", "%23"), heroId, locale
                ),
                accessToken
            );
        ...
        public async Task<Diablo3DetailedFollowersItems> GetDetailedFollowersItems(string accessToken, string region, string account, ulong heroId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Diablo3DetailedFollowersItems>(
                string.Format(
                    "https://{0}.api.blizzard.com/d3/profile/{1}/hero/{2}/follower-items?locale={3}",
                    region, account.Replace("#", "%23"), heroId, locale
                ),
                accessToken
            );
