...
namespace Dysnomia.Common.BlizzardWebAPI {
    ...
    public class Starcraft2Community : BlizzardWebAPIQuerier, IStarcraft2Community {
        ...
        public async Task<Starcraft2StaticProfile> GetStaticProfile(string accessToken, string region, int regionId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Starcraft2StaticProfile>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/static/profile/{1}?locale={2}",
                    region, regionId, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Starcraft2MetadataProfile> GetMetadataProfile(string accessToken, string region, int regionId, int realmId, ulong profileId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Starcraft2MetadataProfile>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/metadata/profile/{1}/{2}/{3}?locale={4}",
                    region, regionId, realmId, profileId, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Starcraft2Profile> GetProfile(string accessToken, string region, int regionId, int realmId, ulong profileId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Starcraft2Profile>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/profile/{1}/{2}/{3}?locale={4}",
                    region, regionId, realmId, profileId, locale
                ),
                accessToken
            );
        ...
        public async Task<Starcraft2ProfileLadderSummary> GetProfileLadderSummary(string accessToken, string region, int regionId, int realmId, ulong profileId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Starcraft2ProfileLadderSummary>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/profile/{1}/{2}/{3}/ladder/summary?locale={4}",
                    region, regionId, realmId, profileId, locale
                ),
                accessToken
            );
        ...
        public async Task<Starcraft2ProfileLadder> GetProfileLadder(string accessToken, string region, int regionId, int realmId, ulong profileId, int ladderId, string locale = "en_US") {
            return await this.GetUsingTokenAsync<Starcraft2ProfileLadder>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/profile/{1}/{2}/{3}/ladder/{4}?locale={5}",
                    region, regionId, realmId, profileId, ladderId, locale
                ),
                accessToken
            );
        }
        ...
        public async Task<Starcraft2GrandmasterLeaderboard> GetGrandmasterLeaderboard(string accessToken, string region, int regionId) {
            return await this.GetUsingTokenAsync<Starcraft2GrandmasterLeaderboard>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/ladder/grandmaster/{1}",
                    region, regionId
                ),
                accessToken
            );
        ...
        public async Task<Starcraft2Season> GetLadderSeason(string accessToken, string region, int regionId) {
            return await this.GetUsingTokenAsync<Starcraft2Season>(
                string.Format(
                    "https://{0}.api.blizzard.com/sc2/ladder/season/{1}",
                    region, regionId
                ),
                accessToken
            );
        ...
        public async Task<Starcraft2Account> GetPlayerAccount(string accessToken, string region, ulong accountId) {
            ...
            for (int i = 0; i < 5; i++) {
                try {
                    return (await this.GetUsingTokenAsync<IEnumerable<Starcraft2Account>>(
                        string.Format(
                            "https://{0}.api.blizzard.com/sc2/player/{1}",
